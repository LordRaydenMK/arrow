...
// HCons(head=1000, tail=HCons(head=900, tail=arrow.generic.HNil@73123e37))
```

```kotlin
Account(1000, 900).toHListLabeled()
// HCons(head=Tuple2(a=balance, b=1000), tail=HCons(head=Tuple2(a=available, b=900), tail=arrow.generic.HNil@73123e37))
```
...
// DeferredK(deferred=LazyDeferredCoroutine{New}@7122175, scope=kotlinx.coroutines.GlobalScope@6ebb8b8f)
```
