...
```kotlin
String.eq()
// arrow.instances.StringKt$eq$1@1ea44667
```

```kotlin
Option.functor()
// arrow.instances.option.functor.OptionFunctorInstanceKt$functor$1@370eaea8
```
...
// arrow.instances.mapk.semigroup.MapKSemigroupInstanceKt$semigroup$1@3bcf763c
```

```kotlin
Either.monadError<Throwable>()
// arrow.instances.either.monadError.EitherMonadErrorInstanceKt$monadError$1@3b184e75
```

```kotlin
ListK.traverse()
// arrow.instances.listk.traverse.ListKTraverseInstanceKt$traverse$2@59dce234
```
...
ListK.functor()
// arrow.instances.listk.functor.ListKFunctorInstanceKt$functor$1@744d4c38
```
